...
const handlePlantsClick = (e) => {
  ...
  const handleAddToCart = (product) => {
    console.log(product, "veo producto");
                ...
                <div key={index}>
                    ...
                    <div className="product-list">
                        ...
                        <div className="product-card" key={plantIndex}>
                            ...
                            <button type="button" disabled={addedToCart[plant.name]}  className="product-button" onClick={() => handleAddToCart(plant)}>{addedToCart[plant.name] ? "Added" : "Add to Cart"}</button>
                        </div>
                        ))}
                    </div>
                </div>
